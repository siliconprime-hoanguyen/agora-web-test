(function($) {
    $(document).ready(function(){
        var args            = window.location.href.split("?"),
            key             = '2cb60be28b74464db9d46ec8d3f2cd47',
            channel         = "d767a2002f2341c2bcab2eb6773f8970",
            videoChecked    = true,
            audioChecked    = true,
            username        = '',
            members         = 0,
        ...
        (function decodeArgumentsFromURL() {
            if(args.length > 1){
                ...
                videoDpi = decodeURI(data["video_profile"]);
                videoDevice = decodeURI(data["video_device"]);
                audioDevice = decodeURI(data["audio_device"]);
